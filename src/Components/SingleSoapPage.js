...
class SingleSoapPage extends Component {
  state = {
  ...
  componentDidMount = async () => {
    ...
    try {
      const movie = await axios.get(
        `https://api.themoviedb.org/3/tv/${this.state.url}?api_key=9bbcbda12cd8e24c3b0faccb7cff4370&language=en-US`
      );
  ...
  url(https://image.tmdb.org/t/p/w1280/${this.state.data.backdrop_path})`,
            ...
            >
              ...
              >
                ...
                <p className="d-none d-xl-block col-md-8 offset-2 text-center mt-5">
                  {" "}
                  ...
                  <div className="row" style={{ marginTop: "90px" }}>
                    ...
                    <div className="col-4">
                      <div>
                        ...
                        >
                          {this.state.data.status.split(" ")[0].toUpperCase()}
                        </div>
                      </div>
                      <div className="my-5">
                        <div>
...
export default withRouter(SingleSoapPage);
